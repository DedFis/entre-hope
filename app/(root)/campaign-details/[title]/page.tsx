...
import { CountBox, CustomButton, Loader } from '../../../../components/ui';
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                <h4 className="font-epilogue font-semibold text-[14px] text-white break-all">{campaign.owner.username}</h4>
